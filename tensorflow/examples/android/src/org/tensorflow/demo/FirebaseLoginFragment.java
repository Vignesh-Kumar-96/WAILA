...
public class FirebaseLoginFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        anonLoginBut = (Button) v.findViewById(R.id.anonLoginButton);
        createFragBut = (Button) v.findViewById(R.id.createFragButton);
        if (loginBut == null || anonLoginBut == null || createFragBut == null) {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        anonLoginBut.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                // Set up a progress dialog
                final ProgressDialog dlg = new ProgressDialog(getActivity());
                dlg.setTitle("Please wait.");
                ...
                mAuth.signInAnonymously()
                        .addOnCompleteListener(getActivity(), new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                // signed in user can be handled in the listener.
                                if (!task.isSuccessful()) {
                                    Log.w(TAG, "SignInAnonymously " + task.getException().getMessage());
                                    Snackbar.make(myRootView,
                                            "Authentication failed: " + task.getException().getMessage(),
                                            Snackbar.LENGTH_LONG)
                                            .setAction("Action", null).show();
